; (function () {
	...
	function Task(name, completed, createdAt, updatedAt){
		if (!name || typeof name !== "string")
            throw Error("first argument for Task must be the task name (string)!")
        ...
        this.getCompleted = () => _completed
        this.toggleDone = () => _completed = !_completed

        this.getCreatedAt = () => _createdAt

        this.getUpdatedAt = () => _updatedAt
        this.setUpdatedAt = (date) => _updatedAt = date
    ...
    function addTask(task) {
        arrInstancesTasks.push(new Task(task, false, new Date()))
        renderTasks()
    ...
    function clickedUl(e) {
        ...
        const actions = {
            ...
            containerEditButton: function () {
                ...
                arrInstancesTasks[currentLiIndex].setUpdatedAt(new Date())
                renderTasks()
            },
